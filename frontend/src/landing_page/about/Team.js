      ...
      >
        ...
        <div className="col-12 col-md-6 p-3 p-md-5 text-center order-2 order-md-1">
          ...
          <div className="mt-4 mt-md-5">
            <h4 className="fw-bold mb-1">Prajwal H</h4>
        ...
        <div className="col-12 col-md-6 p-3 p-md-5 order-1 order-md-2">
          <div className="fs-5 mb-4">
            <p>
              Prajwal H founded Finvero with a clear vision: to create a smarter, more accessible way for individuals to interact with financial markets. As a student entrepreneur, he took the initiative to build Finvero from the ground up, combining his interest in finance, technology, and innovation.
            </p>
