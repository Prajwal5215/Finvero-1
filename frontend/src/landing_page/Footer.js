    ...
    <footer style={styles.footer}>
      <div className="container" style={styles.container}>
        <div className="row" style={getStyles(styles.row)}>
          ...
          <div style={getStyles(styles.logoColumn)}>
            ...
            <p style={styles.copyright}>
              &copy; 2010 - 2024, Not Finvero Broking Ltd. All rights reserved.
            </p>
          </div>
        ...
        <div style={getStyles(styles.textBlock)}>
          <p>
            Finvero Broking Ltd. is a registered stock market platform providing technology-driven solutions for investors and traders. All investment and trading activities on this platform are subject to applicable market risks and regulations. Please ensure you fully understand the associated risks before making any investments.
          </p>

          <p>
            Finvero does not offer any form of stock tips, portfolio management, or guaranteed returns. Users are advised to conduct their own research or consult with certified financial advisors before making any investment decisions. We do not authorize any third party to trade on your behalf.
          </p>

          <p>
            Always keep your mobile number and email address updated to receive timely alerts about your account activity. For any support or complaint, please contact us at <strong style={styles.strong}>support@finvero.com</strong>.
          </p>
          ...
          <p>
            Finvero Broking Ltd., Registered Office: #123, Innovation Park, 2nd Cross, Tech Valley, Bengaluru - 560001, Karnataka, India.
          </p>
        </div>
      </div>
    </footer>
