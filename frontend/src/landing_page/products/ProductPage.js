    ...
    <div className="technology-page">
      ...
      <div className="container-fluid px-0">
        ...
        <RightSection
          ...
          productName="Console"
          productDescription="The central dashboard for your Finvero account. Gain insights into your trades and investments with in-depth reports and visualisations."
          learnMore="Learn More"
        />

        <RightSection
          imageURL="media/kiteconnect.png"
          productName="Finvero Connect API"
